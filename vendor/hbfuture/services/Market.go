...
// 用户资产API
	 ...
	 *            不填默认20，不得多于50
	 */
func FutureContractOrderDetail( symbol,  orderId,  pageIndex,  pageSize, createdAt, orderType string) (string,*http.Response,error) {
	...
	return untils.ApiKeyPost(params, strRequest)
}
    /**
	 * 获取合约当前未成交委托
	 *
	 ...
	 *            不填默认20，不得多于50
	 */
func FutureContractOpenorders( symbol,  pageIndex,  pageSize string) (string,*http.Response,error) {
...
func FutureContractHisorders( symbol,  tradeType, ordertype,  status,
 createDate,  pageIndex,  pageSize string) (string,*http.Response,error) {
	 ...
	 */
func FutureContractOrderInfo( orderId,  clientOrderId, symbol,order_type string) (string,*http.Response,error) {
	 ...
	 *            品种代码，如"BTC","ETH"...
	 */
func FutureContractCancelall(symbol string) (string,*http.Response,error) {
	 ...
	 */
func FutureContractCancel(orderId,symbol ,client_order_id string) (string,*http.Response,error) {
...
func FutureContractBatchorder(orders_data [] *Order) string {
	 ...
	 * @return
	 */
func FutureContractOrder(symbol ,contractType,contractCode,clientOrderId,price,volume,direction,offset,leverRate,orderPriceType string) (string,*http.Response,error) {
	 ...
	 * @return size 获取交易记录的数量 [1, 2000]
	 */
func FutureContractPositionInfo(symbol string) (string,*http.Response,error) {
	strRequest := "/api/v1/contract_position_info"
	params :=make(map[string]string)
	params["symbol"] = symbol
	json, response, err := untils.ApiKeyPost(params, strRequest)
	 ...
	 * @return size 获取交易记录的数量 [1, 2000]
	 */
func FutureContractAccountInfo(symbol string) (string,*http.Response,error) {
